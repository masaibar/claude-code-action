...
jobs:
  claude-response:
    ...
    steps:
      - uses: masaibar/claude-code-action@beta  # Fork with OAuth support
        with:
...
This action is built on top of [`masaibar/claude-code-base-action`](https://github.com/masaibar/claude-code-base-action).
